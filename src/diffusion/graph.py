...
class UniformGraph:
    ...
    def sample_transition(self, x_0: torch.Tensor, p: torch.Tensor) -> torch.Tensor:
        """
        ...
        return torch.where(corrupt_mask, corrupted_tokens, x_0)
...
class AbsorbingGraph:
    ...
    def sample_transition(self, x_0: torch.Tensor, p: torch.Tensor) -> torch.Tensor:
        ...
        return torch.where(absorb_mask, mask_tokens, x_0)
